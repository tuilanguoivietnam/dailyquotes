...
void main() async {
  ...
  // 打开 Hive boxes
  await Hive.openBox<String>('dailylovequotes_favorites');
  await Hive.openBox<Affirmation>('dailylovequotes_affirmations');
  await Hive.openBox<WhiteNoise>('dailylovequotes_whitenoises');
  await Hive.openBox('dailylovequotes_settings');
