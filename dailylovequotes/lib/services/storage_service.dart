...
class StorageService {
  static const String _affirmationBoxName = 'dailylovequotes_affirmations';
  static const String _whitenoiseBoxName = 'dailylovequotes_whitenoises';
  static const String _settingsBoxName = 'dailylovequotes_settings';
  ...
  // 评分服务相关键 - 使用应用前缀避免冲突
  static const String keyAppOpenCount = 'dailylovequotes_app_open_count';
  static const String keyLastPromptDate = 'dailylovequotes_rating_last_prompt_date';
  static const String keyRated = 'dailylovequotes_app_rated';
  static const String keyNeverAsk = 'dailylovequotes_rating_never_ask';

  // 首次请求网络
  static const String keyFirstRequest = 'dailylovequotes_first_request';
  ...
  static Future<void> saveSelectedCategory(String? category) async {
    final box = await Hive.openBox('dailylovequotes_settings');
