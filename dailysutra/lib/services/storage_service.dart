...
class StorageService {
  static const String _affirmationBoxName = 'dailysutra_affirmations';
  static const String _whitenoiseBoxName = 'dailysutra_whitenoises';
  static const String _settingsBoxName = 'dailysutra_settings';
  ...
  // 评分服务相关键
  static const String keyAppOpenCount = 'dailysutra_app_open_count';
  static const String keyLastPromptDate = 'dailysutra_rating_last_prompt_date';
  static const String keyRated = 'dailysutra_app_rated';
  static const String keyNeverAsk = 'dailysutra_rating_never_ask';

  // 首次请求网络
  static const String keyFirstRequest = 'dailysutra_first_request';
  ...
  static Future<void> saveSelectedCategory(String? category) async {
    final box = await Hive.openBox('dailysutra_settings');
