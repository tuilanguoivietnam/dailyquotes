...
class WhiteNoiseNotifier extends StateNotifier<AsyncValue<List<WhiteNoise>>> {
  ...
  static const _lastWhiteNoiseKey = 'dailysutra_last_whitenoise_id';
  static const _prefsBox = 'dailysutra_app_prefs';
  ...
  Future<void> fetchWhiteNoises() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${ApiConfig.baseUrl}/api/whitenoises?module_name=佛经'),
        headers: {
