...
void main() async {
  ...
  // 打开 Hive boxes
  await Hive.openBox<String>('dailybible_favorites');
  await Hive.openBox<Affirmation>('dailybible_affirmations');
  await Hive.openBox<WhiteNoise>('dailybible_whitenoises');
  await Hive.openBox('dailybible_settings');
