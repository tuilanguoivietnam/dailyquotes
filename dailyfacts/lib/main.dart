...
void main() async {
  ...
  // 打开 Hive boxes
  await Hive.openBox<String>('dailyfacts_favorites');
  await Hive.openBox<Affirmation>('dailyfacts_affirmations');
  await Hive.openBox<WhiteNoise>('dailyfacts_whitenoises');
  await Hive.openBox('dailyfacts_settings');
