...
import 'package:dailyfacts/providers/theme_provider.dart';
import 'package:dailyfacts/providers/font_size_provider.dart';
import 'package:dailyfacts/utils/responsive_utils.dart';
import 'package:dailyfacts/widgets/custom_dialog.dart';
...
class _SettingsPageState extends ConsumerState<SettingsPage> {
  ...
  Future<void> _rateApp() async {
    final url = Uri.parse(
        'https://apps.apple.com/us/app/dailyfacts-discover-new-info/id6746777421');
            ...
            Card(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    title: Text('settings.white_noise_volume'.tr()),
                    subtitle: Slider(
                      value: volumeSettings.whiteNoiseVolume,
                      onChanged: (value) async {
                        ref
                            .read(volumeProvider.notifier)
                            .setWhiteNoiseVolume(value);
                        final player =
                            ref.read(whitenoiseProvider.notifier).audioPlayer;
                        try {
                          await player.setVolume(value);
                          print('白噪音音量已设为: $value');
                        } catch (e) {
                          print('设置白噪音音量失败: $e');
                        }
                      },
