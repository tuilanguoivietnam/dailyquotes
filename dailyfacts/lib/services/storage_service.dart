...
class StorageService {
  static const String _affirmationBoxName = 'dailyfacts_affirmations';
  static const String _whitenoiseBoxName = 'dailyfacts_whitenoises';
  static const String _settingsBoxName = 'dailyfacts_settings';
  ...
  // 评分服务相关键 - 使用应用前缀避免冲突
  static const String keyAppOpenCount = 'dailyfacts_app_open_count';
  static const String keyLastPromptDate = 'dailyfacts_rating_last_prompt_date';
  static const String keyRated = 'dailyfacts_app_rated';
  static const String keyNeverAsk = 'dailyfacts_rating_never_ask';

  // 首次请求网络
  static const String keyFirstRequest = 'dailyfacts_first_request';
  ...
  static Future<void> saveSelectedCategory(String? category) async {
    final box = await Hive.openBox('dailyfacts_settings');
