...
void main() async {
  ...
  // 打开 Hive boxes
  await Hive.openBox<String>('dailystory_favorites');
  await Hive.openBox<Affirmation>('dailystory_affirmations');
  await Hive.openBox<WhiteNoise>('dailystory_whitenoises');
  await Hive.openBox('dailystory_settings');
