...
class StorageService {
  static const String _affirmationBoxName = 'dailystory_affirmations';
  static const String _whitenoiseBoxName = 'dailystory_whitenoises';
  static const String _settingsBoxName = 'dailystory_settings';
  ...
  // 评分服务相关键
  static const String keyAppOpenCount = 'dailystory_app_open_count';
  static const String keyLastPromptDate = 'dailystory_rating_last_prompt_date';
  static const String keyRated = 'dailystory_app_rated';
  static const String keyNeverAsk = 'dailystory_rating_never_ask';

  // 首次请求网络
  static const String keyFirstRequest = 'dailystory_first_request';
  ...
  static Future<void> saveSelectedCategory(String? category) async {
    final box = await Hive.openBox('dailystory_settings');
  ...
  static Future<String?> getGoogleSubscriptionId() async {
    final box = await Hive.openBox('dailybible_settings');
    return box.get('google_subscription_id');
  }

  static Future<void> saveGoogleSubscriptionId(String subscriptionId) async {
    final box = await Hive.openBox('dailybible_settings');
    await box.put('google_subscription_id', subscriptionId);
  }
